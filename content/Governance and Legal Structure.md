---
title: Governance and Legal Structure
tags:
  - kmikeym
  - governance
  - legal
...
Decisions are made by shareholder vote (the full record is at [[List of Votes]], and [[Votes]] explains how the system works in practice). Voting weight is proportional to holdings: one share, one vote (see [[Shareholder Registry]]). The outcome is binding on Merrill. A proposal may be **binary**, approved or rejected, or **multi-option**, choosing between named alternatives; the second form has carried most of the voting since 2019 and the binary form was last used in October 2021.
