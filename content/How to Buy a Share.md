...
Buying your first share of [[KmikeyM]] takes one page and a card. Go to [kmikeym.com/buy](https://kmikeym.com/buy), enter an amount, and check out. **There is no separate signup step**: if you do not have an account, one is created from the email you use at checkout. This page covers what the money buys, what it costs, what happens to your first share (which is a special case), and what you can do once you hold one.

## The short version

1. Go to [kmikeym.com/buy](https://kmikeym.com/buy).
2. Enter an amount. Checkout is handled by Stripe.
3. Your deposit immediately buys as many shares as it can at the best available price, minus processing fees.
4. An account is created for you if you did not already have one.
