...
- **Take an offer that already exists.** You get filled immediately at that price. This is what [kmikeym.com/buy](https://kmikeym.com/buy) does with your money automatically, and what the Buy control does on the trading page.
...
**Getting cash off the platform is not a self-serve control.** The site has a deposit path and no withdrawal button. If you want money out rather than sitting in a balance to trade with, ask Mike.

## Where you can see the market

Only partly in public. **The full book of bids and asks requires an account.** Without one you can see the current price and the ladder of shares currently for sale on [kmikeym.com/buy](https://kmikeym.com/buy), which is enough to buy but not enough to see who wants what. The complete two-sided book, your own offers, and the price history chart are behind login.
